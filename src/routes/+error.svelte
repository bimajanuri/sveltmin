<script lang="ts">
  import GridShape from '$lib/components/common/GridShape.svelte';
  import PageMeta from '$lib/components/common/PageMeta.svelte';
</script>

<PageMeta
  title="SvelteKit 404 Dashboard | TailAdmin - SvelteKit Admin Dashboard Template"
  description="This is SvelteKit 404 Dashboard page for TailAdmin - SvelteKit Tailwind CSS Admin Dashboard Template"
/>
