<script lang="ts">
  ...
  import Input from '$lib/components/form/input/InputField.svelte';
...
<div class="flex flex-col flex-1 w-full overflow-y-auto lg:w-1/2 no-scrollbar">
            ...
            <div>
              ...
              <div class="relative">
                ...
                >
                  ...
                  {:else}
                    <svg class="fill-gray-500 dark:fill-gray-400 size-5" viewBox="0 0 24 24" fill="none">
                      <path d="M17.94 17.94C16.2306 19.243 14.1643 19.9522 12 20C5 20 1 12 1 12C2.24301 9.653 3.96703 7.65294 6.05999 6.06003M9.91003 9.91003C9.32144 10.4952 8.99195 11.2927 9.00003 12.1125C9.00811 12.9323 9.35305 13.701 9.95499 14.2401M12 14.5C12.8284 14.5 13.5 13.8284 13.5 13C13.5 12.1716 12.8284 11.5 12 11.5C11.1716 11.5 10.5 12.1716 10.5 13C10.5 13.8284 11.1716 14.5 12 14.5Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                      <path d="M10.59 10.59C9.9478 11.2283 9.59285 12.0994 9.60003 13C9.60721 13.9006 9.97544 14.7581 10.63 15.37" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
