<script lang="ts">
  ...
  function getIcon(variant: string) {
    switch (variant) {
      case 'success':
        return `<svg class="fill-current" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      case 'error':
        return `<svg class="fill-current" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
