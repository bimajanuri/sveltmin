<script lang="ts">
  import { ThemeToggleButton } from '$lib/components/common';
  ...
  let isApplicationMenuOpen = writable(false);

  function toggleApplicationMenu() {
    isApplicationMenuOpen.update(n => !n);
  }
</script>
...
<header class="sticky top-0 flex w-full bg-white border-gray-200 z-99999 dark:border-gray-800 dark:bg-gray-900 lg:border-b">
  <div class="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
    <div class="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-gray-200 dark:border-gray-800 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
      <button
        class="block w-10 h-10 text-gray-500 lg:hidden dark:text-gray-400"
        on:click={onToggle}
      >
        <!-- Hamburger Icon -->
        <svg
      ...
      <button
        class="items-center justify-center hidden w-10 h-10 text-gray-500 border-gray-200 rounded-lg z-99999 lg:flex dark:text-gray-400 lg:h-11 lg:w-11 lg:border"
      >
        <svg
